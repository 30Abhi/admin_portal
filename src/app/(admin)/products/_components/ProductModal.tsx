...
export default function ProductModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center p-4">
      ...
      <form
        onSubmit={onSubmit}
        className="relative z-10 w-full max-w-xl bg-white rounded-lg border border-black/[.08] p-6 shadow-sm flex flex-col gap-4 max-h-[90vh] overflow-y-auto" // scrollable classes 
      >
